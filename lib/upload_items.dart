...
class _ItemsUploadScreenState extends State<ItemsUploadScreen>
{
    ...
    if (imageFileUint8List != null) {
      if (sellerNameTextEditingController.text.isNotEmpty &&
        ...
        try {
          ...
          downloadUrlOfUploadedImage = await taskSnapshot.ref.getDownloadURL();
  ...
  saveItemInfoToFirestore() async {
    ...
    try {
      ...
      Fluttertoast.showToast(msg: "Your new item has been uploaded successfully.");
      ...
      print("Error saving item info to Firestore: $e");
      Fluttertoast.showToast(msg: "Failed to save item info.");
      setState(() {
        isUploading = false;
      });
    }
